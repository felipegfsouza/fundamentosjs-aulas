class JogoDaMemoria {
  ...
  exibirHerois(nomeDoHeroi){
    // vamos procurar esse heroi pelo nome em nossos heroisInisciais
    // vamos obter somente a imagem dele
    const { img } = this.heroisIniciais.find(({ nome }) => nomeDoHeroi === nome)
    //vamos criar a funcao na tela para exibir somente heroi selecionado
      ...
      case 1:
        ...
        if(opcao1.nome === item.nome &&
          ...
          opcao1.id !== item.id
            ...
            // como padrao e true, não precisa passar nada
